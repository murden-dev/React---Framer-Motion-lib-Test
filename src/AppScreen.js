...
class AppScreen extends Component {
  render() {
    ...
    <ThemeProvider theme={theme}>
      ...
      transition={{ delay: 0.8, duration: .4, type: "spring", stiffness: 100, mass: 1, damping: 15 }}
      >
      ...
      initial={{ y: -50, opacity: 0}}
      animate={{ y: 0, opacity: 1 }}
      transition={{ delay: 1.6, duration: .2, type: "spring", stiffness: 100, mass: 3, damping: 25 }}
      >
        We know<span>.</span>
      </motion.h1>
      ...
      <motion.div // linha horizontal acima
        ...
        animate={{ y: 0, opacity: 1}}
        transition={{ delay: 2.6, duration: .5, staggerChildren: 0.2}}
        >
          ...
          transition={{ delay: 2.6, duration: .6, type: "spring", mass: 2, damping: 50 }}
          >
            <svg width="375" height="147" viewBox="0 0 375 147" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          initial={{y: 100, x: 0, opacity: 0}}
          animate={{y: 0, x: [0, 5, -5, 0], opacity: 1}}
          transition={{ delay: 2.8, duration: .6, type: "spring", mass: 2, damping: 50 }}
          >
            <svg width="375" height="147" viewBox="0 0 375 147" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          initial={{y: 100, x: 0, opacity: 0}}
          animate={{y: 0, x: [0, 5, -5, 0], opacity: 1}}
          transition={{ delay: 3, duration: .6, type: "spring", mass: 2, damping: 50 }}
          >
            <svg width="375" height="147" viewBox="0 0 375 147" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        transition={{ delay: 2.6, duration: .4, type: "spring", mass: 1, damping: 20 }}
        >
        ...
        transition={{ delay: 2.6, duration: .2, type: "spring", stiffness: 100, mass: 1, damping: 25 }}
        >
        ...
        transition={{ delay: 2.6, duration: .3, type: "spring", mass: 2, damping: 50 }}
        >
      ...
      initial={{y: 50, opacity: 0}}
      animate={{y: 0, opacity: 1}}
      transition={{ delay: 3, duration: .2, type: "spring", mass: 1, damping: 25 }}
      >
          <TextField
          label="E-mail"
          margin="dense"
